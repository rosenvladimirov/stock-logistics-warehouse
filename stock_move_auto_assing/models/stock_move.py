...
from odoo.addons.stock.models.stock_move import StockMove as stock_action_assing
        ...
        for move in self.filtered(lambda m: m.state in ['confirmed', 'waiting', 'partially_available']):
            ...
            if move.location_id.should_bypass_reservation() \
                ...
                if not move.move_orig_ids:
                    ...
                    strict = self._context.get("force_strict", False) or self._context['force_strict']
...
stock_action_assing._action_assign = StockMove._action_assign
